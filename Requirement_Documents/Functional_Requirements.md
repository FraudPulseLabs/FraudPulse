...
4.1 Classify transactions as `ALLOW`, `ALLOW_WITH_REVIEW`, or `BLOCK`
...
4.5 Place medium-risk transactions into ALLOW_WITH_REVIEW
...
## FR-10. Reconciliation — _Out of scope (v2)_
...
15.6 Display transaction lifecycle timelines / SLA
...
16.4 Report number of ALLOW_WITH_REVIEWed transactions
...
16.8 Report model performance metrics
...
17.6 Allow admins to export system data
...
18.6 Allow demo reset before presentation
